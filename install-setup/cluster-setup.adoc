...
summary: 'Après l"installation de votre matériel AFX, vous pouvez finaliser la configuration du cluster ONTAP. Ce processus implique des phases de configuration associées que vous devez effectuer séquentiellement.' 
---
...
[role="lead"]
Après l'installation de votre matériel AFX, vous pouvez finaliser la configuration du cluster ONTAP. Ce processus implique des phases de configuration associées que vous devez effectuer séquentiellement.
...
Avant de configurer votre cluster ONTAP, vous devez consulter les exigences de base d'AFX afin de vous assurer que vous disposez de toutes les informations et ressources nécessaires pour mener à bien le processus de configuration.
