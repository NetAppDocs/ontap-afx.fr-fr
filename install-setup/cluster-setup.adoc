...
Lors de la première installation et configuration d'AFX, vous pouvez inclure NetApp AI Data Engine (AIDE). Si vous prévoyez de configurer AIDE, vous devrez d'abord effectuer les opérations suivantes :

* Assurez-vous de  https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["installer AIDE"^] et d'attacher les nœuds de calcul au réseau de stockage AFX.
* Obtenez les adresses et toute configuration réseau associée pour les data compute nodes.
...
. Si vous installez AI Data Engine avec votre système de stockage AFX, fournissez les adresses IP des trois nœuds AIDE DCN.
...
.Quelle est la prochaine étape
* Si vous avez inclus AIDE dans la configuration du cluster AFX, vous devrez effectuer des étapes de configuration supplémentaires, notamment la gestion des licences et l'authentification. Voir https://docs.netapp.com/us-en/ai-data-engine/install-setup/cluster-setup-afx.html["Configurer AI Data Engine"^] pour plus d'informations.
