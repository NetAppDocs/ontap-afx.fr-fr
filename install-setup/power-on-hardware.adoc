...
Après avoir mis sous tension votre système de stockage AFX 1K, terminez la configuration en fonction de votre option de déploiement :

* Pour les déploiements de systèmes de stockage AFX 1K dédiés, rendez-vous sur link:../install-setup/cluster-setup.html["Configurer un cluster AFX"].
* Pour les déploiements AFX 1K avec AI Data Engine (AIDE), installez des serveurs tiers AIDE ou des nœuds de calcul de données fournis par NetApp :
