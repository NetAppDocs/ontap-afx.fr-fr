...
* Pour les déploiements AFX 1K avec AI Data Engine (AIDE), rendez-vous sur le link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Installer les nœuds de calcul de données AIDE"].
