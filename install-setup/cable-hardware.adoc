...
* L'utilisation simultanée de connexions (câbles) cuivre et optiques n'est pas prise en charge par les adaptateurs NIC NVIDIA C6X-DX et CX7 (100GbE). Vous devez utiliser exclusivement des connexions cuivre ou optiques et éviter de combiner différents types de connexions. Le mélange des types peut entraîner une saturation du lien après une utilisation prolongée.
+
Assurez-vous de disposer des câbles adaptés à votre type de connexion avant de câbler les commutateurs.

+

NOTE: Pour plus d'informations sur le mélange des types de connexion, consultez l'article de la base de connaissances NetApp link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-Issues/CHW-3504["Des erreurs de liaison CRC sont observées sur la carte réseau CX6-DX avec des câbles de dérivation mixtes en cuivre et en fibre optique sur les ports"^].
...
+
image::../media/drw_afx_ha_cluster_storage_a_ieops-2779.svg[Cluster de contrôleurs câblés,800px,and storage to switch A]
...
+
image::../media/drw_afx_ha_cluster_storage_b_ieops-2780.svg[Cluster de contrôleurs câblés,800px,and storage to switch B]
