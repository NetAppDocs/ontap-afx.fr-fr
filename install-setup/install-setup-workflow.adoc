...
NOTE: Si vous déployez AFX 1K avec l’AI Data Engine (AIDE), installez les nœuds de calcul de données AIDE après la mise sous tension du système AFX. Reportez-vous à link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Installer les nœuds de calcul de données AIDE"] pour plus d’informations.
