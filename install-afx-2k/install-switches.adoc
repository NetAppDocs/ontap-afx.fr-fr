...
summary: Découvrez comment installer les commutateurs pour le système de stockage AFX 2K et les étagères de stockage. 
---
= Installez les commutateurs de votre système de stockage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Une fois vos préparatifs pour l'installation du système de stockage AFX 2K terminés, vous devez installer les commutateurs dans l'armoire ou le rack télécom.
...
NOTE: Si le flux d'air de vos commutateurs est configuré pour une aspiration côté ports (ventilateurs et alimentations de couleur bordeaux), les ports réseau des commutateurs doivent être installés face à l'avant de l'armoire et les ventilateurs d'extraction face à l'arrière de l'armoire. Avec cette configuration, vous devez vous assurer d'utiliser des câbles suffisamment longs pour relier les ports réseau situés à l'avant de l'armoire aux ports de stockage situés à l'arrière de l'armoire. + Pour plus d'informations détaillées sur ces commutateurs, veuillez visiter le site web de Cisco : link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-modular-overview-ph2.html["Guide d'installation matérielle du commutateur Cisco Nexus 9808"^], link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9332d-gx2b/cisco-nexus-9332d-gx2b-nx-os-mode-switch-hardware-installation-guide.html["Guide d'installation matérielle du commutateur de mode Cisco Nexus 9332D-GX2B"^], et link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9364d-gx2a/cisco-nexus-9364d-gx2a-nx-os-mode-switch-hardware-installation-guide.html["Guide d'installation matérielle du commutateur de mode Cisco Nexus 9364D-GX2A"^].
...
== Installation du commutateur Cisco Nexus 9808

Si vous installez le commutateur Cisco Nexus 9808, reportez-vous à la link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-install-chassis.html["Guide d'installation matérielle du commutateur Cisco Nexus 9808"^] pour obtenir des instructions détaillées sur la manière d’installer les commutateurs dans l’armoire ou le rack.



[[cisco-nexus-9332d-gx2b-and-9364d-gx2a-switch-installation]]
== Installation des commutateurs Cisco Nexus 9332D-GX2B et 9364D-GX2A

Si vous installez Cisco Nexus 9332D-GX2B ou 9364D, effectuez les étapes suivantes pour installer les commutateurs dans l'armoire ou le rack.
...
.. Faites passer les connecteurs femelles des deux cordons de raccordement depuis l'arrière du panneau à travers l'ensemble de brosses.
+
...
+
Installez les deux commutateurs dans des emplacements d'armoire qui offrent un accès efficace aux contrôleurs et aux étagères, comme les rangées du milieu.
...
Après avoir installé les commutateurs dans l'armoire ou le rack, vous link:deploy-hardware.html["Installez le système de stockage AFX 2K et les étagères dans l'armoire ou le rack"].
