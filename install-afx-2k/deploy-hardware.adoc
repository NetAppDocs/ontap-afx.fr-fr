...
summary: 'Apprenez comment installer les kits de rails pour le système de stockage AFX 2K et les tiroirs disques, et sécuriser le matériel AFX dans l"armoire ou le rack télécom.' 
---
= Installez votre système de stockage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Après avoir installé les commutateurs, vous devez installer le matériel de votre système de stockage AFX 2K. Commencez par installer les kits de rails. Ensuite, installez et fixez votre système de stockage dans une armoire ou une baie de brassage.
...
. Si votre système de stockage AFX 2K est livré avec un dispositif de gestion des câbles, fixez-le à l'arrière du système de stockage.
+
...
Après avoir installé le matériel de votre système AFX, consultez le link:afx-cable-overview.html["Configurations de câblage prises en charge pour votre système de stockage AFX 2K"].
