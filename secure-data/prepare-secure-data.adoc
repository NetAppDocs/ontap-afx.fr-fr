...
---
= Découvrez les options de sécurité des données pour les systèmes de stockage AFX
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Sécurité du protocole Internet:: IPsec est une norme Internet qui assure le chiffrement, l'intégrité et l'authentification des données en transit pour le trafic entre les points de terminaison du réseau au niveau IP. Elle sécurise tout le trafic IP entre ONTAP et les clients, y compris les protocoles de niveau supérieur tels que NFS et SMB. IPsec offre une protection contre les attaques par rejeu malveillant et les attaques de type homme du milieu sur vos données. Consultez link:../secure-data/secure-ip-connections.html["Sécurité IP pour les systèmes de stockage AFX"] pour plus d'informations.
