...
* https://docs.netapp.com/us-en/ontap/data-protection/cloud-backup-with-snapmirror-task.html["Sauvegardez des données dans le cloud à l'aide d'ONTAP SnapMirror Cloud"^]
