...
.Résultat
Les mises à jour recommandées sont automatiquement téléchargées et installées sur votre système ONTAP AFX en fonction de vos sélections de mise à jour.
