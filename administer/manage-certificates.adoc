...
* https://docs.netapp.com/us-en/ontap/authentication/install-server-certificate-cluster-svm-ssl-server-task.html["Générer et installer un certificat serveur signé par une autorité de certification dans ONTAP"^]
