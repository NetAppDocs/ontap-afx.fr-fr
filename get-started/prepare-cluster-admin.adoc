...
Nœuds de contrôleur par cluster:: Chaque cluster AFX doit comporter au moins quatre nœuds. Le nombre maximal de nœuds varie selon la version d'ONTAP ; par exemple, la version 9.19.1 autorise jusqu'à 32 nœuds par cluster AFX.
